...
function getLinkByStatus($status, $level)
{
    ...
    switch ($status) {
        ...
        case \App\TicketStatus::DISETUJUI_BAGREN:
            switch ($level) {
                case \App\UserAccess::LEVEL_PPK:
                    $link = route('ticketing.view-ppk');
                    break;
