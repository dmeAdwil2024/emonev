                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <select name="filter_satker" id="filter_satker" class="form-control"
                                    ...
                                    <option value="dpuprpkp">Dinas Pekerjaan Umum, Penataan Ruang, Perumahan dan Kawasan
                                        Permukiman</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <div class="col-md-12">
                                <table id="data" style="width:100%"
                                    class="table table-bordered table-striped text-xs">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center text-uppercase">Jabatan dalam Satker
                                            </th>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" name="id_request" id="id_request" class="form-control"
                                        style="display:none" />
                                </div>
                            </div>
...
<script>
    function reload() {
        ...
        $.post('{{ route('master.data-request-user') }}', {
            status,
            satker,
            _token: '{{ csrf_token() }}'
        }, function(e) {
            ...
            $("#data").DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'kode_satker',
                            className: "text-center text-uppercase align-middle"
                        },
                        {
                            data: 'bidang',
                            className: "text-uppercase align-middle"
    ...
    function rejectForm(id) {
        ...
        $.post('{{ route('tools.detail-request') }}', {
            id,
            _token: '{{ csrf_token() }}'
        }, function(e) {
