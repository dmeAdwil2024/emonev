    ...
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="nota_dinas_pptk">Nota Dinas PPTK Sudah Sign <small>(PDF, Maksimal 2MB)</small></label>
                ...
                {{-- <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="nota_dinas_ppk">Nota Dinas Untuk PPK (Kosong) <small>(PDF, Maksimal 2MB)</small></label>
                        <div class="input-group">
                            <div class="custom-file">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="matrik_rab">Matrik RAB Semula Menjadi <small>(PDF, Maksimal 2MB)</small></label>
                        <div class="input-group">
                            <div class="custom-file">
                    ...
                    <div class="form-group col-md-6">
                        <label for="kak">KAK <small>(PDF, Maksimal 2MB)</small></label>
                        <div class="input-group">
                            <div class="custom-file">
                ...
                <div class="form-group">
                    <label for="dokumen_pendukung">Dokumen Pendukung Lainnya (Optional) <small>(PDF/JPG/DOCX, Maksimal 2MB)</small></label>
                    <div class="input-group">
                        <div class="custom-file">
