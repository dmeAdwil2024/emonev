    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="row">
                ...
                Capaian Output > Capaian Pusat > Komponen Input > SubKomponen
                </div>
            </div>
                ...
                <div class="col-md-11" style="background-image: linear-gradient(to right, rgba(204,204,255,0.7) , rgba(102,255,204,0.7));"><br>
                    <div class="row">
                        ...
                        <table cellpadding=3 class="tbl_caput" width=100%>
                            ...
                            <tr>
                                <td align=center><div class="isi_caputa">+</div></td>
                                <td><a href="{{route('capaian.komponen')}}" class="btn"><div class="isi_caput">1237.PBL.001.061<br>Penguatan Sekertariat Bersama Pembinaan GWPP</a></div></td>
                                <td><div class="isi_caput">100%</div></td>
                                <td><div class="isi_caput">539427293</div></td>
                                <td><div class="isi_caput">539427293</div></td>
                                <td><div class="isi_caput">100%</div></td>
                            ...
                            <tr>
                                <td align=center><div class="isi_caputa">+</div></td>
                                <td><div class="isi_caput"><a href="{{route('capaian.validasi-capaian-output')}}" class="btn">1237.PBL.001.061.AB<br>Koordinasi Sekertariat Bersama Pembinaan GWPP</a></div></td>
                                <td><div class="isi_caput">100%</div></td>
                                <td><div class="isi_caput">539427293</div></td>
                                <td><div class="isi_caput">539427293</div></td>
                                <td><div class="isi_caput">100%</div></td>
