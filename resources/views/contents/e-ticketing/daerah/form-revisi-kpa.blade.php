            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                ...
                <select
                  ...
                  id="status_kpa"
                >
                  <option value="{{ \App\TicketStatus::PERBAIKAN }}" {{ $data->status_kpa == \App\TicketStatus::PERBAIKAN ? 'selected' : '' }}>Perbaikan</option>
                  <option value="{{ \App\TicketStatus::DISETUJUI_KPA }}" {{ $data->status_kpa == \App\TicketStatus::DISETUJUI_KPA ? 'selected' : '' }}>Disetujui</option>
                </select>
              </div>
              <div class="mb-3 setuju">
                ...
                <input
                  ...
                  aria-describedby=""
                  placeholder=""
                  value="{{ $data->no_nota_kpa }}"
                />
              </div>
              <div class="mb-3 setuju">
                <label for="lampiran_kpa" class="form-label">Nota Dinas KPA</label>
                @if (! empty($data->lampiran_kpa))
                <a class="mx-3" href="{{ route('download.dokumen', ['jenis_file' => 'lampiran_kpa', 'nama_file' => $data->lampiran_kpa]) }}">{{ $data->lampiran_kpa }}</a>
                @endif
                <input
                  type="file"
                  class="form-control"
