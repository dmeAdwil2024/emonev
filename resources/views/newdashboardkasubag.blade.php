...
<body>
                ...
                <ul class="list-unstyled collapse ps-3" id="menuTiketing">
                  ...
                  <li>
                    ...
                    <ul class="list-unstyled collapse ps-3" id="menuRevda">
                      ...
                      <li><a href="#" class="btn btn-sm btn-warning btn-pills mb-1">Revisi kegiatan Sarpras</a>
                      </li>
                    </ul>
                  </li>
          ...
          <ul class="nav nav-tabs" id="realisasiAnggaranTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="uke2-tab" data-toggle="tab" data-target="#tcUke2" type="button"
                role="tab" aria-controls="home" aria-selected="true">UKE II</button>
            </li>
            <li class="nav-item" role="presentation">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="sa-uke2-tab" data-toggle="tab" data-target="#saUke2"
                type="button" role="tab" aria-controls="home" aria-selected="true">UKE II</button>
            </li>
            <li class="nav-item" role="presentation">
  ...
  <script>
    ...
    new Chart(chartRealisasiUk2, {
      type: 'bar',
      data: {
        labels: ['Sekretariat', 'Direktorat A', 'Direktorat B', 'Direktorat C', 'Direktorat D', 'Direktorat E'],
        datasets: [{
