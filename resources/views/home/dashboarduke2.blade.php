...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        @php
            ...
            $persen_realisasi_rm    = $rm_pusat == 0 ? 0 : $realisasi/$rm_pusat*100;
            $persen_sisa_rm         = $rm_pusat == 0 ? 0 : $sisa_rm_pusat/$rm_pusat*100;
                        ...
                        <div class="row fw-semibold">
							<div class="col-12">
								<div class="text-center">
									...
									<div>
										<font color="#8a63b1" class="legend"><strong>---</strong></font><font color=#000 class="legend"> : Rata-rata kemendagri ({{$rata2_realisasi_eselon1}}%)</font><br>
										<font color="#ff3300" class="legend"><strong>---</strong></font><font color=#000 class="legend"> : Rata-rata UKE II Ditjen Bina Adwil ({{$rata2_realisasi_eselon2}}%)</font><br>
									</div>
								</div>
							</div>
                        </div>
                                    ...
                                    <div class="row">
										<div class="text-center col-md-3">
											...
											<div class="canvas-container">
												<canvas id="chartRealKewenangan_pusat" class="canvas" align=center></canvas>
											</div><br>
											Realisasi<br>
                            ...
                            <ul class="nav nav-tabs" id="tabsSisaAnggaran" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        id="sisaUke2-tab"
                                        data-bs-toggle="tab"
                                        data-bs-target="#sisaUke2"
                                        type="button"
                                        role="tab"
                                        aria-controls="sisaUke2"
                                        aria-selected="false">
        ...
        <script>
			...
			$.post("{{route('grafiksanding')}}",{'id_dir':'{{$id_dir}}','alias_dir':'{{$alias_dir}}','_token':'{{csrf_token()}}'},function(data, status){
