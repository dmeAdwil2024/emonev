    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="main">
                    ...
                    <div class="col-md-4">
                        <div class="card card-dongker text-center">
                            <div class="card-body">
                                ...
                                <span class="position-absolute end-0 bottom-0">
                                    <a class="btn btn-sm btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalSisaAnggaran">&#129106;</a>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 px-5">
						<div class="col-12">
							<div class="text-center classWithPad" id=graphchartRealEs3Adwil></div>
						</div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-check form-check-inline">
                        <input
                            class="form-check-input tiperekaprevisi"
                            type="radio"
                            name="tiperekaprevisi"
                            id="tiperekaprevisi_pusat"
                            value="pusat"
							checked
                        />
                    ...
                    <div class="row mt-3">
                                ...
                                <select
									...
									@php
										foreach($dir_data as $item){
											echo '<option value="'.$item->id_dir.'">'.$item->nama_dir.'</option>';
										}
									@endphp
                                </select>
                                <select
									...
									@php
										foreach($prov_data as $item){
											echo '<option value="'.$item->namaprov.'">'.$item->namaprov.'</option>';
										}
									@endphp
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mb-3">
								<a href="javascript:getrev()" class="btn btn-info btn-sm"><i class='fa fa-repeat'></i> Cari</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                        <div class="mb-3">
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title fs-5">Data Sanding Realisasi, Capaian Output dan Kinerja</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body bg-light-grey">
                                <div class="row" id=div_chartsandinguke2><font color=#000>Loading data sandingan UKE II...</font><br></div>
							</div>
                        </div>
                    </div>
                </div>
				
                <div class="modal fade" id="modalrealuke3" data-bs-backdrop="static" tabindex="-1" style="z-index:1825">
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="modalsisauke3" data-bs-backdrop="static" tabindex="-1" style="z-index:1825">
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body bg-light-grey">
                                <div class="row" id=div_sisauke3><font color=#000>Loading data sisa UKE III...</font><br></div>
							</div>
                        </div>
                    </div>
                </div>
				
                <div class="modal fade" id="modalsandinguke3" data-bs-backdrop="static" tabindex="-1" style="z-index:1825">
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body bg-light-grey">
                                <div class="row" id=div_chartsandinguke3><font color=#000>Loading data sanding UKE III...</font><br></div>
							</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body bg-light-grey">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-2">
                                        <select class="form-select form-select-sm" name="jenis_revisi" id="jenis_revisi" onclick="f_jenisrevisi()">
                                    ...
                                    <div class="col-8">
                                    <p class="h3 text-end fw-bold">Rp {{number_format($anggaran,2,',','.')}}</p>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="card my-3" data-jenis="{{ $pagu->jenis }}" data-sort="d{{ $pagu->date_sort }}">
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h6 class="card-subtitle mb-3 text-body-secondary">{{ $pagu->nominal }}</h6>
                                                    </div>
                                                    <div class="col-12">
                ...
                <!-- Modal -->
                <div class="modal hide fade" id="modalRealisasiAnggaran" data-bs-keyboard="false" tabindex="-1"  aria-hidden="true" style="z-index:1824">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="modalRealisasiAnggaranLabel">Realisasi Anggaran</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            ...
                            <ul class="nav nav-tabs" id="tabsRealisasiAnggaran" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        id="realisasiKewenangan-tab"
                                        data-bs-toggle="tab"
                                        data-bs-target="#realisasiKewenangan"
                                        type="button"
                                        role="tab"
                                        aria-controls="realisasiKewenangan"
                                        aria-selected="false">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
										<div class="text-center col-md-3">
											...
											<div class="canvas-container">
												<canvas id="chartRealKewenangan_pusat" class="canvas" align=center height=280></canvas>
											</div><br>
											Realisasi<br>
										...
										<div class="text-center col-md-3">
											...
											<div class="canvas-container">
												<canvas id="chartRealKewenangan_dekon" class="canvas" align=center></canvas>
											</div><br>
											Realisasi<br>
										...
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Tugas Perbantuan<br>
											<div class="canvas-container">
												<canvas id="chartRealKewenangan_tp" class="canvas" align=center></canvas>
											</div><br>
											Realisasi<br>
                                ...
                                <div
                                    class="tab-pane"
                                    id="realisasiSumberDana"
                                    role="tabpanel"
                                    aria-labelledby="realisasiSumberDana-tab">
                                    <div class="row">
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Rupiah Murni<br>
											<div class="canvas-container">
												<canvas id="chartRealSumberDana_rm" class="canvas" align=center></canvas>
											</div><br>
											Realisasi<br>
										...
										<div class="text-center col-md-3">
											...
											<div class="canvas-container">
												<canvas id="chartRealSumberDana_pln" class="canvas" align=center></canvas>
											</div><br>
											Realisasi<br>
				...
				<!-- Modal -->
				<div class="modal fade" id="modalSisaAnggaran" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <ul class="nav nav-tabs" id="tabsSisaAnggaran" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link active"
                                        id="sisaKewenangan-tab"
                                        data-bs-toggle="tab"
                                        data-bs-target="#sisaKewenangan"
                                        type="button"
                                        role="tab"
                                        aria-controls="sisaKewenangan"
                                        aria-selected="true">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link"
                                        id="sisaSumberDana-tab"
                                        data-bs-toggle="tab"
                                        data-bs-target="#sisaSumberDana"
                                        type="button"
                                        role="tab"
                                        aria-controls="sisaSumberDana"
                                        aria-selected="true">
                                ...
                                <div
                                    ...
                                    <div class="row">
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Pusat<br>
											<div class="canvas-container">
												<canvas id="chartSisaKewenangan_pusat" class="canvas" align=center></canvas>
											</div><br>
											sisa<br>
										...
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Dekon<br>
											<div class="canvas-container">
												<canvas id="chartSisaKewenangan_dekon" class="canvas" align=center></canvas>
											</div><br>
											sisa<br>
										...
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Tugas Perbantuan<br>
											<div class="canvas-container">
												<canvas id="chartSisaKewenangan_tp" class="canvas" align=center></canvas>
											</div><br>
											sisa<br>
                                ...
                                <div
                                    ...
                                    <div class="row">
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">Rupiah Murni<br>
											<div class="canvas-container">
												<canvas id="chartSisaSumberDana_rm" class="canvas" align=center></canvas>
											</div><br>
											sisa<br>
										...
										<div class="text-center col-md-3">
											<div class="text-center classWithPad kotakdonut">PLN<br>
											<div class="canvas-container">
												<canvas id="chartSisaSumberDana_pln" class="canvas" align=center></canvas>
											</div><br>
											sisa<br>
        ...
        <script>
			        ...
			        success: function(data) {
						...
						if(data!=''){
				            $.each(data, function(key, value) {
				                select.append('<option value="' + value.id + '">' + value.nama_subdir + '</option>');
				            });
						}
			        },
			...
			$("#selrevprov").click(function(){
				...
				$.ajax({
			        ...
			        success: function(data) {
						...
						if(data!=''){
				            $.each(data, function(key, value) {
				                select.append('<option value="' + value.jenis_satker + '">' + value.jenis_satker + '</option>');
				            });
						}
			        },
			        error: function(xhr, status, error) {
            ...
            new Chart(chartRealSumberDana_rm, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_rm_pusat, 2, '.', '')}}","{{number_format((float)$persen_rm_pusat_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_rm_pusat, 2, '.', '')}},{{number_format((float)$persen_rm_pusat_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_rm_pusat}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartRealSumberDana_pln, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_realisasi_phln, 2, '.', '')}}","{{number_format((float)$persen_realisasi_phln_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_realisasi_phln, 2, '.', '')}},{{number_format((float)$persen_realisasi_phln_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_realisasi_phln}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartRealKewenangan_pusat, {
                type: 'doughnut',
                data: {
		            labels: ["{{number_format((float)$persen_realisasi_pusat, 2, '.', '')}}","{{number_format((float)$persen_realisasi_pusat_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_realisasi_pusat, 2, '.', '')}},{{number_format((float)$persen_realisasi_pusat_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_realpusat}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartRealKewenangan_dekon, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_realisasi_dekon, 2, '.', '')}}","{{number_format((float)$persen_realisasi_dekon_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_realisasi_dekon, 2, '.', '')}},{{number_format((float)$persen_realisasi_dekon_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_realdekon}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartRealKewenangan_tp, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_realisasi_tp, 2, '.', '')}}","{{number_format((float)$persen_realisasi_tp_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_realisasi_tp, 2, '.', '')}},{{number_format((float)$persen_realisasi_tp_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_realtp}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartSisaSumberDana_rm, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_sisa_rm, 2, '.', '')}}","{{number_format((float)$persen_sisa_rm_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_sisa_rm, 2, '.', '')}},{{number_format((float)$persen_sisa_rm_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_sisa_rm_pusat}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartSisaSumberDana_pln, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_sisa_phln, 2, '.', '')}}","{{number_format((float)$persen_sisa_phln_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_sisa_phln, 2, '.', '')}},{{number_format((float)$persen_sisa_phln_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_sisa_phln}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartSisaKewenangan_pusat, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_sisa_pusat, 2, '.', '')}}","{{number_format((float)$persen_sisa_pusat_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_sisa_pusat, 2, '.', '')}},{{number_format((float)$persen_sisa_pusat_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_sisapusat}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartSisaKewenangan_dekon, {
                type: 'doughnut',
                data: {
	                labels: ["{{number_format((float)$persen_sisa_dekon, 2, '.', '')}}","{{number_format((float)$persen_sisa_dekon_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_sisa_dekon, 2, '.', '')}},{{number_format((float)$persen_sisa_dekon_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_sisadekon}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartSisaKewenangan_tp, {
                type: 'doughnut',
                data: {
                	labels: ["{{number_format((float)$persen_sisa_tp, 2, '.', '')}}","{{number_format((float)$persen_sisa_tp_sisa, 2, '.', '')}}"],
                    datasets: [{
                        data: [{{number_format((float)$persen_sisa_tp, 2, '.', '')}},{{number_format((float)$persen_sisa_tp_sisa, 2, '.', '')}}],
						backgroundColor: [
                        '{{$bgcolor_sisatp}}',
                        bgcolor_abu,
                        ],
            ...
            new Chart(chartPaguKewenangan, {
                type: 'doughnut',
                data: {
                    labels: ['Pusat Rp. {{number_format((float)$pagu_pusat)}} ({{number_format((float)$persen_pagu_pusat)}})', 'Dekon Rp. {{number_format((float)$pagu_dekon)}} ({{number_format((float)$persen_pagu_dekon)}})','Tugas Perbantuan Rp. {{number_format((float)$pagu_tp)}} ({{number_format((float)$persen_pagu_tp)}})'],
                    datasets: [{
                        data: [{{number_format((float)$persen_pagu_pusat)}}, {{number_format((float)$persen_pagu_dekon)}}, {{number_format((float)$persen_pagu_tp)}} ],
						backgroundColor: [
                        'rgb(10,185,95)',
                        'rgb(0,118,236)',
                        'rgb(252,224,88)',
            ...
            new Chart(chartPaguSumberDana, {
                type: 'doughnut',
                data: {
                    labels: ['RM Rp. {{number_format((float)$rm_pusat)}} ({{number_format((float)$persen_rm_pusat)}})', 'PLN Rp. {{number_format((float)$phln_pusat)}} ({{number_format((float)$persen_pagu_phln)}})'],
                    datasets: [{
                        data: [{{number_format((float)$persen_rm_pusat)}}, {{number_format((float)$persen_pagu_phln)}} ],
						backgroundColor: [
                        'rgb(233,127,46)',
                        'rgb(204,0,102)',
                        'rgb(29,245,202)',
			...
			$("#graphchartRealEs3").html('<div class="outer" style="height:280px"><div id="inner"><img src="{{ asset('images/spinner.gif') }}" width=50><br><font color=#000>Loading data realisasi UK III...</font></div></div>');
			$.post("{{route('barRealUke3')}}",{'alias_dir':label_uke2,'realisasi':{{$anggaran_adwil}},'rata2_realisasi_eselon2':{{$rata2_realisasi_eselon2}},'_token':'{{csrf_token()}}'},function(e, status){
				getRealEselon3(label_uke2,e.subdir_uke3,e.real_uke3,e.real_uke3_rata2,e.real_uke2_rata2,e.real_uke3_rata2_legend,e.real_uke2_rata2_legend)
			});
			
            function getRealEselon3(label_uke2,subdir_uke3,real_uke3,real_uke3_rata2,real_uke2_rata2,real_uke3_rata2_legend,real_uke2_rata2_legend)
            {
				strlegend='<font color="#ff3300"><strong>---</strong></font><font color=#000 class=legend style="font-weight:500"> : Rata-rata UKE II Ditjen Bina Adwil ('+real_uke2_rata2_legend+'%)</font><br>';
				strlegend+='<font color="#009966"><strong>---</strong></font><font color=#000 class=legend style="font-weight:500"> : Rata-rata UKE III '+label_uke2+' ('+real_uke3_rata2_legend+'%)</font><br>';
				
				s='<div class="hide" id=chartRealEs3_title><h3 class="mb-3 fw-bold h6 ">Realisasi Anggaran per UK III Lingkup Direktorat '+label_uke2+'</h3></div>'
			...
			label_uke2adwil=''
			$("#graphchartRealEs3Adwil").html('<div class="outer" style="height:280px"><div id="inner"><img src="{{ asset('images/spinner.gif') }}" width=50><br><font color=#000>Loading data realisasi UK III...</font></div></div>');
			$.post("{{route('barRealUke3')}}",{'realisasi':{{$anggaran_adwil}},'rata2_realisasi_eselon2':{{$rata2_realisasi_eselon2}},'_token':'{{csrf_token()}}'},function(e, status){
				getRealEselon3_adwil(label_uke2adwil,e.subdir_uke3,e.real_uke3,e.real_uke3_rata2,e.real_uke2_rata2,e.real_uke3_rata2_legend,e.real_uke2_rata2_legend)
			});
			
            function getRealEselon3_adwil(label_uke2adwil,subdir_uke3,real_uke3,real_uke3_rata2,real_uke2_rata2,real_uke3_rata2_legend,real_uke2_rata2_legend)
            {
				strlegend='<font color="#ff3300"><strong>---</strong></font><font color=#000 class=legend style="font-weight:500"> : Rata-rata UKE II Ditjen Bina Adwil ('+real_uke2_rata2_legend+'%)</font><br>';
				strlegend+='<font color="#009966"><strong>---</strong></font><font color=#000 class=legend style="font-weight:500"> : Rata-rata UKE III lingkup Adwil ('+real_uke3_rata2_legend+'%)</font><br>';
				
				s='<div class="hide" id=chartRealEs3Adwil_title><h3 class="mb-3 fw-bold h6 ">Realisasi Anggaran per UK III Lingkup Adwil</h3></div>'
                s+='     <div class="hide chart-box" style="width:100%;height:0px" id=chartRealEs33Adwil_hd>'
                s+='         <canvas id="chartRealEs3Adwil"></canvas>'
                s+='     </div>'
				s+='	<div id="chartRealEs33Adwil_legend">'+strlegend+'</div>'
				document.getElementById('graphchartRealEs3Adwil').innerHTML=s;
				
				$('#chartRealEs33Adwil_hd').show();
				$('#chartRealEs33Adwil_hd').height(280);
				
				const chartReal3Adwil = document.getElementById('chartRealEs3Adwil');

                new Chart(chartReal3Adwil, {
                    type: 'bar',
                    data: {
                        labels:eval(subdir_uke3),
                        datasets: [{
			...
			$("#grafiksanding").html('<div class="outer"><div id="inner"><img src="{{ asset('images/spinner.gif') }}" width=80><br>Loading data sandingan...</div></div>');
			$.post("{{route('grafiksanding')}}",{'id_dir':'{{$id_dir}}','id_subdir':'{{$id_subdir}}','alias_dir':'{{$alias_dir}}','_token':'{{csrf_token()}}'},function(data, status){
				$('#grafiksanding').html(data)
			});
			
			$("#graphchartPaguEs3").html('<div class="outer" style="height:280px"><div id="inner"><img src="{{ asset('images/spinner.gif') }}" width=50><br><font color=#000>Loading data realisasi UK III...</font></div></div>');
			$.post("{{route('rekapEselon3')}}",{'id_dir':label_uke2,'_token':'{{csrf_token()}}'},function(e, status){
			...
			const centerDoughnutPlugin = {
			    ...
			    beforeDraw: (chart) => {
				  ...
				  if(chartnm.substring(0,14)=='chartRealUke2_'||chartnm.substring(0,14)=='chartRealUke3_'||chartnm.substring(0,14)=='chartsisaUke2_'||chartnm.substring(0,14)=='chartsisaUke3_'||chartnm=='chartRealKewenangan_pusat'||chartnm=='chartRealKewenangan_dekon'||chartnm=='chartRealKewenangan_tp'||chartnm=='chartRealSumberDana_rm'||chartnm=='chartRealSumberDana_pln'||chartnm=='chartSisaKewenangan_pusat'||chartnm=='chartSisaKewenangan_dekon'||chartnm=='chartSisaKewenangan_tp'||chartnm=='chartSisaSumberDana_rm'||chartnm=='chartSisaSumberDana_pln'){
				  	  ctx.restore();
