    ...
    <body>
            ...
            <div class="main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 px-5">
                        ...
                        <div class="chart-box" style="height: 300px; width:100%;">
							...
							<div id="chartRealisasi_kemendagri"><font color="#8a63b1"><strong>---</strong></font><font color=#000>: Rata-rata kemendagri ({{$rata2_realisasi_eselon1}}%)</font></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="row">
									<div class="col-6">
										<div class="text-center">
											...
											<div>
												<font color="#8a63b1"><strong>---</strong></font><font color=#000> : Rata-rata kemendagri ({{$rata2_realisasi_eselon1}}%)</font><br>
												<font color="#ff3300"><strong>---</strong></font><font color=#000> : Rata-rata UKE II Ditjen Bina Adwil ({{$rata2_realisasi_eselon2}}%)</font><br>
											</div>
										</div>
									</div>
									<div class="col-6">
										<div class="text-center classWithPad">
	                                        ...
	                                        <div class="hide chart-box" style="width:100%;height:0px" id=chartRealEs3_hd>
                ...
                <div class="modal fade" id="modalsanding" data-bs-backdrop="static">
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title fs-5">Data Sanding Realisasi, Capaian Output dan Kinenrja</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body bg-light-grey">
        ...
        <script>
            ...
            new Chart(chartPusat, {
                type: 'doughnut',
                data: {
                    labels: [{{number_format((float)$persen_realisasi_pusat, 2, '.', '')}}, {{number_format((float)$persen_sisa_pusat, 2, '.', '')}}],
                    datasets: [{
            ...
            new Chart(chartDekon, {
                type: 'doughnut',
                data: {
                    labels: [{{number_format((float)$persen_realisasi_dekon, 2, '.', '')}}, {{number_format((float)$persen_sisa_dekon, 2, '.', '')}}],
                    datasets: [{
            ...
            new Chart(chartTugas, {
                type: 'doughnut',
                data: {
                    labels: [{{number_format((float)$persen_realisasi_tp, 2, '.', '')}}, {{number_format((float)$persen_sisa_tp, 2, '.', '')}}],
                    datasets: [{
           ...
           chartReal=new Chart(chartRealisasi, {
            ...
            function getRealEselon3(label_uke2,subdir_uke3,real_uke3,real_uke3_rata2,real_uke2_rata2,real_uke3_rata2_legend,real_uke2_rata2_legend)
            {
				...
				strlegend='<font color="#ff3300"><strong>---</strong></font><font color=#000> : Rata-rata UKE II Ditjen Bina Adwil ('+real_uke2_rata2_legend+'%)</font><br>';
				strlegend+='<font color="#009966"><strong>---</strong></font><font color=#000> : Rata-rata UKE III '+label_uke2+' ('+real_uke3_rata2_legend+'%)</font><br>';
				document.getElementById("chartRealEs3_hd").innerHTML = '<canvas id="chartRealEs3"></canvas>';
				document.getElementById("chartRealEs3_title").innerHTML = '<h3 class="mb-3 fw-bold h6 ">'+label_uke2+'</h3>';
			...
			$.post("{{route('grafiksanding')}}",{'_token':'{{csrf_token()}}'},function(data, status){
            ...
            function getEselon3(label_eselon2,subdir_eselon3,pagu_eselon3)
            {
				...
				document.getElementById("chartPaguEs3_title").innerHTML = '<h3 class="mb-3 fw-bold h6 ">'+label_eselon2+'</h3>';
