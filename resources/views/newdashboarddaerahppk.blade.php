...
<body>
  ...
  <div class="container">
    <div class="row mb-3 mt-5">
      <div class="col-md-4">
        <div class="card card-dongker text-center">
          <div class="card-body position-relative">
            <h5 class="card-title h6">Pagu Anggaran Tugas X</h5>
      ...
      <div class="col-md-4">
        <div class="card card-dongker text-center">
          <div class="card-body">
            <h5 class="card-title h6">Realisasi Anggaran Tugas X</h5>
      ...
      <div class="col-md-4">
        <div class="card card-dongker text-center">
          <div class="card-body">
            <h5 class="card-title h6">Sisa Anggaran Tugas X</h5>
            <p class="h5">Rp 000.000.000,00<br>&nbsp;</p>
            <div class="progress mb-2" role="progressbar" aria-label="Success example 4px high" aria-valuenow="25"
              aria-valuemin="0" aria-valuemax="100" style="height: 4px">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 px-5">
        <h3 class="fw-bold h5 mb-3 text-center">Realisasi Anggaran per Tugas Satker X Provinsi X</h3>
        <div class="chart-box" style="height: 300px; width:100%;">
          <canvas id="chartRealisasiTugas" aria-label="Realisasi Anggaran per Tugas Satker X Provinsi X" role="img"></canvas>
        </div>
      </div>
      <div class="col-md-6 px-5">
        <h3 class="fw-bold h5 mb-3 text-center">Realisasi Anggaran Satker Provinsi X</h3>
        <div class="chart-box" style="height: 300px; width:100%;">
          <canvas id="chartRealisasiSatker" aria-label="Realisasi Anggaran Satker Provinsi X"
            role="img"></canvas>
        </div>
      </div>
    </div>
              ...
              <div class="d-flex p-3 gap-3">
                ...
                <div class="mb-3">
                  <div class="mb-3">
                    ...
                    <select class="form-select form-select" name="" id="selectJenisRevisi">
  ...
  <script>
    const chartRealisasiTugas = document.getElementById('chartRealisasiTugas');
    const chartRealisasiSatker = document.getElementById('chartRealisasiSatker');
    ...
    new Chart(chartRealisasiTugas, {
      type: 'bar',
      data: {
        labels: ['Tugas A', 'Tugas B', 'Tugas C', 'Tugas D', 'Tugas E', 'Tugas F'],
        datasets: [{
          label: 'Realisasi Anggaran per Tugas Satker X Provinsi X',
          data: [40, 35, 30, 25, 60, 80],
          borderWidth: 1,
    ...
    new Chart(chartRealisasiSatker, {
      type: 'bar',
      data: {
        labels: ['Satker A', 'Satker B', 'Satker C', 'Satker D'],
        datasets: [{
          label: 'Realisasi Anggaran Satker Provinsi X',
          data: [100, 90, 80, 70],
          borderWidth: 1,
          backgroundColor: '#2C83D2'
        }]
