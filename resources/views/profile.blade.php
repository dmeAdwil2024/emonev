            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="{{env('APP_URL')}}/images/user.png" alt="{{Auth::user()->nama}}" />
                        </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted text-capitalize">{{strtolower(getSatker(Auth::user()->kdsatker, "nama_satker"))}}</p>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                    ...
                    <div class="card-body">
                        <form class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control bg-white" id="nama" value="{{Auth::user()->nama}}" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email" class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control bg-white" id="email" value="{{Auth::user()->email}}" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="no_hp" class="col-sm-2 col-form-label">Nomor HP</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control bg-white" id="no_hp" value="{{Auth::user()->no_hp}}" />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="kdsatker" id="kdsatker" class="form-control select2">
                                        ...
                                        @foreach($data_satker as $satker)
                                            <option value="{{$satker->kode}}" @if(Auth::user()->kdsatker == $satker->kode) selected @endif>
                                                {{$satker->nama_satker}}                                                
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-2 col-sm-10">
                                    <button type="button" onclick="changeProfile()" class="btn btn-success font-weight-bolder">
                                        <i class="fas fa-save"></i> &nbsp; Simpan Data
                                    </button>

                                    <button type="button" onclick="changePassword('{{Auth::user()->username}}')" class="btn btn-danger ml-3 font-weight-bolder">
...
@section('js')
    <script>
        function changeProfile()
        {
            ...
            $.post('{{ route('users.update') }}', {nama, email, no_hp, kdsatker, _token: '{{csrf_token()}}'}, function(e){
