...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="loginBlock" class="login-box">
            <a href="javascript:void();" class="btn-enter" onclick="myFunction();"><img src="{{asset('newdashboard/images/arrow-right.png')}}" alt="" class="d-inline-block img-fluid me-2"> MASUK</a>
            <form class="mt-3">
                <div class="mb-3">
