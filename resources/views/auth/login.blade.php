...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/fonts/icomoon/style.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/bootstrap.min.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/animate.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/owl.carousel.min.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/owl.theme.default.min.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/bootstrap-datepicker.css" />

        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/fonts/flaticon/font/flaticon.css" />

        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/aos.css" />
        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/jquery.fancybox.min.css" />

        <link rel="stylesheet" href="{{env('APP_URL')}}/landing-pages/css/style.css" />
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="site-wrap">
            <div class="site-blocks-cover" id="home-section">
                <div class="img-wrap">
                    <div class="owl-carousel slide-one-item hero-slider">
                        <div class="slide">
                            <img src="{{env('APP_URL')}}/images/header-logo.png" alt="Image" width="25px" />
                        </div>
                    </div>
                </div>
                <div class="container">
                            ...
                            <div class="intro">
                                <div class="text">
                                    ...
                                    <p class="text-center mt-3">
                                        <a href="javascript:void(0)" onclick="openModalLogin()" style="margin: 5px;" class="btn btn-success btn-md ">
                                            Masuk
                                        </a>
                                        <a href="javascript:void(0)" onclick="openModalResetPassword()" style="margin: 5px;" class="btn btn-warning btn-md ">
                                            Lupa Password?
                                        </a>
                                        <a href="{{route('register')}}" style="margin: 5px;" class="btn btn-danger btn-md"> Daftar</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row mb-5">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="{{env('APP_URL')}}/images/1.png" alt="Image" class="img-fluid" />
                        </div>
                        <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
                            <h3>Pejabat Pelaksana Teknis Kegiatan (PPTK)</h3>
                            <p class="mb-4">
                                Pejabat Pelaksana Teknis Kegiatan (PPTK) mengajukan revisi anggaran kemudian akan ditindak lanjut oleh pejabat berwenang sesuai alur. Setiap tahap proses, PPTK akan mendapatkan notifikasi sudah sejauh mana
                                pengajuan revisi sudah ditindak lanjuti
                            </p>
                            <p class="mb-4"><a href="javascript:void(0)" class="readmore" onclick="openModalLogin()" style="color: #00457C">Masuk</a></p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-5 h-100 jm-sticky-top mr-auto order-2 order-lg-1">
                            ...
                            <p class="mb-4">Pejabat Pembuat Komitmen (PPK) memproses pengajuan revisi yang sudah diajukan oleh Pejabat Pelaksana Teknis Kegiatan (PPTK) dengan memvalidasi dokumen yang diupload oleh PPTK</p>
                            <p class="mb-4"><a href="javascript:void(0)" class="readmore" onclick="openModalLogin()" style="color: #00457C">Masuk</a></p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
                            ...
                            <p class="mb-4">Bagian Perencanaan (Bagren) memverifikasi pengajuan revisi dari PPTK yang sudah diproses sebelumnya oleh Pejabat Pembuat Keputusan (PPK)</p>
                            <p class="mb-4"><a href="javascript:void(0)" class="readmore" onclick="openModalLogin()" style="color: #00457C">Masuk</a></p>
                        </div>
                    </div>
                </div>
            ...
            <footer class="site-footer" style="padding-bottom: 1rem !important; padding-top: 2rem !important; margin-top: 2rem !important;">
                <div class="container">
                ...
                <div class="modal-content" style="background-color: #001A3A; border-radius: 14px; padding: 10px">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                <label for="username_forgot" class="col-sm-4 col-form-label text-white">Username</label>
                                <div class="col-sm-8">
                                    <input type="text" name="username_forgot" id="username_forgot" class="form-control" />
                                </div>
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times-circle"></i> Cancel</button>
                        <button type="submit" id="btn-reset-password" class="btn btn-success" onclick="submitResetPassword()">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group row">
                                <label for="pangkat" class="col-sm-4 col-form-label text-white">Pangkat & Golongan</label>
                                <div class="col-sm-8">
                                    <input type="text" name="pangkat" id="pangkat" class="form-control" />
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="no_hp" class="col-sm-4 col-form-label text-white">Nomor Whatsapp</label>
                                <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                <label for="jabatan_dalam_satker" class="col-sm-4 col-form-label text-white">Jabatan dalam Satker</label>
                                <div class="col-sm-8">
                                    <select onchange="checkJabatan()"  name="jabatan_dalam_satker" id="jabatan_dalam_satker" class="form-control select2">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select onchange="checkJabatan()" name="satker" id="satker" class="form-control select2">
                                        <option value="" selected disabled>Pilih Salah Satu</option>
                              ...
                              <div class="form-group row">
                                    <label for="sk_penunjukkan" class="col-sm-4 col-form-label text-white">SK Penunjukkan</label>
        ...
        <script src="{{env('APP_URL')}}/landing-pages/js/bootstrap.min.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/owl.carousel.min.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/aos.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/jquery.sticky.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/stickyfill.min.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/jquery.easing.1.3.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/isotope.pkgd.min.js"></script>

        <script src="{{env('APP_URL')}}/landing-pages/js/jquery.fancybox.min.js"></script>
        <script src="{{env('APP_URL')}}/landing-pages/js/main.js"></script>
        <!-- Select2 -->
