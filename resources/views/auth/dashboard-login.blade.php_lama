...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 text-center">
                    <img src="{{asset('newdashboard/images/logo-kemendagri.png')}}" alt="logo kemendagri" class="img-fluid margin-auto logo">
                </div>
                <div class="col-md-6">
                    <div class="dashboard-title">
                        ...
                        <p>Mempermudah proses pelaporan data realisasi hasil pemantauan pelaksanaan rencana kerja Ditjen Bina Adwil Kementrian Dalam Negeri Republik Indonesia</p>
                    </div>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{asset('newdashboard/images/logo-emonev.png')}}" alt="logo emonev" class="img-fluid margin-auto logo">
                </div>
            </div>
            <div class="row my-3">
                <div class="col-md-4">
        ...
        <div id="loginBlock" class="login-box">
            <a href="#" class="btn-enter" onclick="myFunction()"><img src="{{asset('newdashboard/images/arrow-right.png')}}" alt="" class="d-inline-block img-fluid me-2"> MASUK</a>
            <form class="mt-3" method="POST" action="{{ route('login') }}" >
                ...
                <div class="d-flex gap-3">
                    ...
                    <div class="col-6">
                        ...
                        <a href="javascript:void(0)" onclick="openModalResetPassword()" style="margin: 5px;" class="text-white d-block py-2">Lupa Password?</a>
                    </div>
