    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="site-section" id="portfolio-section">
                <div class="container">
                    <div class="row justify-content-center mb-5">
                        <img src="{{env('APP_URL')}}/images/logo-emonev.png" width="150px">
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="jabatan_dalam_satker" class="col-sm-4 col-form-label">Jabatan dalam Satker</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="sk_penunjukkan" class="col-sm-4 col-form-label">SK Penunjukkan</label>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <select name="provinsi" id="provinsi" onchange="loadSatker()" class="form-control select2">
                                                        <option value="none" selected disabled>Pilih Salah Satu</option>
                                            ...
                                            <div class="form-group row">
                                                <label for="kode_satker" class="col-sm-4 col-form-label">Kode Satuan Kerja</label>
                                                <div class="col-sm-8">
                                ...
                                <div class="card-footer justify-content-between">
                                    <a href="/" class="btn btn-danger"><i class="fas fa-times-circle"></i> Cancel</a>
                                    <button type="submit" id="btn-daftar" class="btn btn-success float-right" onclick="submitRegistrasi()">
        ...
        <script>
            ...
            function loadSatker()
            {
                ...
                $.post('{{ route('satker') }}', {provinsi, _token: '{{csrf_token()}}'}, function(e){
            ...
            function submitRegistrasi()
            {
                ...
                if(nip == "" || nama == "" || no_hp == "" || email == "" || satker == "" || kode_satker == "" || jabatan == "" || pangkat == "" || jabatan_dalam_satker === null || satker === null || sk == "" || provinsi === null || document.getElementById("sk_penunjukkan").files.length == 0)
                {
