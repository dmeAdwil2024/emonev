...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('') }}templates/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
    ...
    <link rel="stylesheet"
        href="{{ asset('') }}templates/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
    <!-- BS Stepper -->
    ...
    <div class="container-fluid">
        <div class="navigasi">
            ...
            <ul class="list-unstyled">
                ...
                @if (Auth::user()->level == '0' || Auth::user()->username == '198505062004121001')
                    <li>
                        <a href="#menuAplikasi" class="btn btn-dongker" data-bs-toggle="collapse">Aplikasi
                            &#11206;</a>
                        <ul class="list-unstyled collapse ps-3" id="menuAplikasi">
                            ...
                            <li>
                                <a href="https://sidirli-trantibumlinmas.kemendagri.go.id/"
