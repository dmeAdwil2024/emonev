...
<html lang="en">
    ...
    <body class="hold-transition dark-mode sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed text-sm">
        ...
        <!-- JEasyUI -->
        <script type="text/javascript" src="{{env('APP_URL')}}/templates/jeasyui/jquery.min.js"></script>
        <script type="text/javascript" src="{{env('APP_URL')}}/templates/jeasyui/jquery.easyui.min.js"></script>
        <!-- Bootstrap -->
