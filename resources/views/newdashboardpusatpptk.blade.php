...
<body>
        ...
        <div class="row">
            <div class="col-md-6 px-5">
                ...
                <div class="chart-box" style="height: 300px; width:100%;">
                    <canvas id="chartRealisasiUk3Dir" aria-label="Realisasi Anggaran per UK II"
                        role="img"></canvas>
                </div>
            </div>
            <div class="col-md-6 px-5">
    ...
    <script>
        ...
        new Chart(chartRealisasiUk3Adw, {
            type: 'bar',
            data: {
                labels: ['Subdit A', 'Subdit B', 'Subdit C', 'Subdit D', 'Subdit E', 'Subdit F', 'Subdit G',
                    'Subdit H', 'Subdit I', 'Subdit J', 'Subdit K', 'Subdit L', 'Subdit M', 'Subdit N',
                    'Subdit O', 'Subdit P'
                ],
                datasets: [{
