...
<body>
    ...
    <div class="row">
      <div class="col-md-6 px-5">
        ...
        <div class="chart-box" style="height: 300px; width:100%;">
          <canvas id="chartRealisasiSatkerDa" aria-label="Realisasi Anggaran per UK II" role="img"></canvas>
        </div>
      </div>
      <div class="col-md-6 px-5">
  ...
  <script>
    ...
    new Chart(chartRealisasiSatkerDa, {
      type: 'bar',
      data: {
        labels: ['Provinsi A', 'Provinsi B', 'Provinsi C', 'Provinsi D', 'Provinsi E', 'Provinsi F', 'Provinsi G', 'Provinsi H', 'Provinsi I'],
        datasets: [{
